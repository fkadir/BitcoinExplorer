...
addr_recv = ("0.0.0.0", 8333, 0)  # Replace with the address of the receiving node
...
payload = struct.pack("<iQq26s26sQsQ", version, services, timestamp, addr_recv, addr_from, nonce, user_agent, start_height)
